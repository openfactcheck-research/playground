...
// Form state
const email = ref('')
const emailFromQuery = ref(false) // true when email was pre-filled from the redirect query param
const code = ref('')
...
// Pre-fill email if passed via query string (e.g. redirected from signup/login)
onMounted(() => {
