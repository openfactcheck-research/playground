    ...
    init(this: Blockly.Block): void {
      ...
      this.appendDummyInput()
        ...
        .appendField(new FieldButton('Sample', () => {
          this.setFieldValue(SAMPLES[sampleIndex]!, 'INPUT_TEXT')
        ...
        .appendField(new FieldButton('Upload', () => {
          ...
          input.onchange = (e) => {
            ...
            reader.onload = () => this.setFieldValue(reader.result as string, 'INPUT_TEXT')
        ...
        .appendField(new FieldButton('URL', () => {
          Blockly.dialog.prompt('Enter a URL to fetch text from:', '', (text) => {
            if (text?.trim())
              this.setFieldValue(text, 'INPUT_TEXT')
          })
        }, ICON_LINK))
